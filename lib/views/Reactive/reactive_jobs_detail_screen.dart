...
class ReactiveJobsDetailsScreen extends StatefulWidget {
  String title;
  List<GetWorkOrderByTypeModel> gettasldatalist;
 // List<GetTaskLogDataResponse> gettasldatalist;

  ReactiveJobsDetailsScreen({Key? key, required this.title,required this.gettasldatalist}) : super(key: key);

  @override
  _ReactiveJobsDetailsScreenState createState() =>
      _ReactiveJobsDetailsScreenState();
}

class _ReactiveJobsDetailsScreenState extends State<ReactiveJobsDetailsScreen> {
...
//  List<BuildingAutogeneratedModel> buildinglist = [];
 /* getbuildingsdata() async{
    ...
    await Webservices.RequestGetBuilding(context, buildinglist, true, "1");
    setState((){});
  }
*/
  ...
  getApi(bool load)async{
    getworklist.clear();
    setState((){});
    await Webservices.RequestGetWorkOrders(context, getworklist, load, "2", "/0");
    print("getworklist>>>>${getworklist.length}");
    setState((){});
  }
    ...
    return MediaQuery(
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          preferredSize: Size.fromHeight(mediaQuerryData.size.height*0.32),
          child: AppBar(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      color: myColors.white,
                     // height: mediaQuerryData.size.height*0.09,
                      child: Container(
            ...
            child: Column(
              children: [
               /* Container(
                ...
                //list................................................................................................................................
            widget.gettasldatalist.isEmpty ? Container():
                Container(
                    margin: EdgeInsets.fromLTRB(0, 0, 0, 0),
                    child: ListView.builder(
                        physics: ClampingScrollPhysics(),
                        shrinkWrap: true,
                        itemCount: widget.gettasldatalist.length,
                        itemBuilder: (context, int index) {
                          reactiveCheckList.add(ReactiveModel("ahgh", false, false),);
                          return InkWell(
                            onTap: () {
                            ...
                            child: Container(
                              ...
                              child: ReactiveJobDetailList(index: index, datalist:  widget.gettasldatalist[index], statusId: "2",),
                            ),
                          );
                        })),
        ...
        bottomNavigationBar: InkWell(
          onTap: assignedList.isEmpty ? (){}:(){
            PersistentNavBarNavigator.pushNewScreen(
              context,
              screen: AssignResourcesScreen(),
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: assignedList.length > 0
                  ? myColors.app_theme
                  : myColors.btn_light_blue,
            ),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Container(
                  child: CustomText.CustomBoldText(MyString.ASSIGN_RESOURCE,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: assignedList.length > 0
                        ? myColors.white
                        : myColors.circle_light_blue,
                  ),
                  child: Center(
                      child: Image.asset(assignedList.length > 0
                          ? "assets/images/img_user_plus_theme.png"
                          : "assets/images/img_user_plus_light_blue.png")),
                ),
              ],
            ),
          ),
...
class ReactiveJobDetailList extends StatefulWidget {
  String statusId;
  int index;
  GetWorkOrderByTypeModel datalist;
 // GetTaskLogDataResponse datalist;

  ReactiveJobDetailList({required this.index,required this.datalist,required this.statusId});
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color:  widget.index == 2 || widget.index == 4? Colors.orangeAccent:myColors.app_theme,
                              ),
                              child: Center(
                                child: Text(
                             widget.index == 2 || widget.index == 4? "Viewed" :    MyString.New,
          ...
          Row(
            children: [
              Container(
                ...
                child: CustomText.CustomRegularText(MyString.Date,
                    myColors.black, FontWeight.w500, 16, 1, TextAlign.center),
              ),
              Expanded(child: Container()),
